...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { code: @block.code, user_id: @block.user_id } }, as: :json
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { code: @block.code, user_id: @block.user_id } }, as: :json
    assert_response 200
  end
